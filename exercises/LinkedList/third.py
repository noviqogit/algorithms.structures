...
# of a singly LinkedList, given only access to that node.
# EXAMPLE
# lnput:the node c from the LinkedList a->b->c->d->e->f
# Result: nothing is returned, but the new LinkedList looks like a->b->d->e->f
